            ...
            <div className="container-lg">
                <div className="row justify-content-center bg-grey">
                    <div className="col-lg-10" id="back">
                        ...
                        <div className="text-center text-azure" id="back-text">
                            <h1>Hi! There, I am Chandra Srinivas P</h1>
            ...
            <div class="container-lg">
                <div class="row justify-content-center align-item-center">
                    <div class="col-md-5 text-center text-md-start border border-secondary" style={{backgroundColor: "rgb(214, 213, 213)"}}>
                        <h1>
                            <div class="display-4">Chandra Srinivas P</div>
                        ...
                        <div class="contact">
                            ...
                            <span class="lead"><i class="bi bi-envelope-at-fill"></i> How to reach me : 
                                <a href="mailto:chandrasrinivas12@gmail.com" class="btn btn-sm btn-primary fw-bold">Email</a>
                            </span>
                            <br /><br />
                            <span class="lead"><i class="bi bi-geo-fill"></i> Kakinada, Andhra Pradesh</span>
                            <br /><br />
                            <span class="lead fw-900"><i class="bi bi-at"></i> Connect with me : </span>
                            <p class="btn-group">
                                <a href="https://www.linkedin.com/in/chandra-srinivas-789091296" target="_blank" class="btn btn-sm btn-success fw-bold"><i class="bi bi-linkedin"></i> Linked In</a>
                                <a href="https://github.com/Chandrasrinivas12" target="_blank" class="btn btn-warning btn-sm fw-bold"><i class="bi bi-github"></i> GitHub</a>
                                <a href="https://github.com/Chandrasrinivas12" target="_blank" class="btn btn-sm btn-danger fw-bold">LeetCode</a>
                            </p>
                    ...
                    <div class="col-md-5 text-center d-none d-md-block">
                        <span class="tt" data-bs-placement="bottom" title="Chandra Srinivas P">
        ...
        <section id="info" class="bg-light mt-5" style={{padding: "60px 0px"}}>
            <div class="container-lg">
                ...
                <div class="row my-5 aligh-items-center justify-content-center">
                    <div class="col-8 col-lg-4 col-xl-3">
                        <div class="card border-info border-2">
                            ...
                            <div class="card-body text-center py-4">
                                ...
                                <a href="https://github.com/Chandrasrinivas12" class="btn btn-outline-danger btn-md mt-3" target="_blank">View</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-8 col-lg-4 col-xl-3">
                    ...
                    <div class="col-8 col-lg-4 col-xl-3">
                        <div class="card border-info border-2">
                            <h4 class="card-header border-info text-center">AWS</h4>
                            <div class="card-body text-center py-4">
                                <h5 class="card-title">All of my works in this domain</h5>
                                <p class="card-text mx-3 my-1 text-muted d-none d-lg-block">Amazon Web Services (AWS) is a comprehensive cloud computing platform provided by Amazon.com. It offers a wide range of services that cater to different computing needs, including computing power, storage options, networking capabilities, and many others. </p>
                                <a href="https://aws-emergingtalent.influitive.com/profiles/a1190411-361a-4f6a-9b8d-145912f7ed40" class="btn btn-outline-danger btn-md mt-3" target="_blank">View</a>
                            </div>
                        </div>
                    </div>
                </div>
...
export function Upload(){
    return(
        <section id="upload" className='mt-5' style={{backgroundColor: "rgb(240, 238, 238)", height:"650px"}}>
            <div class="container-lg">
                <div class="text-center">
                    <h2><i class="bi bi-stars"></i>GITHUB Solution</h2>
                    <p class="lead text-muted">Solutions which i have uploaded in GITHUB</p>
                </div>
                    ...
                    <div class="col-lg-8">
                        <div class="list-group">
                            <div class="list-group-item py-3">
                                ...
                                <p class="mb-1">Task 1</p>
                                <div class="d-flex justify-content-between">
                                    <small>Difficulty : Easy</small>
                                    <a href="https://github.com/Chandrasrinivas12/MERN_tasks" target="_blank" class="btn btn-outline-success active">View the Code</a>
                                </div>
                            </div>

                            <div class="list-group-item py-3">
                                <div class="d-flex justify-content-between">
                                    <h5 class="mb-1">project 2
                                        <i class="bi bi-star-fill"></i>
                                        <i class="bi bi-star-fill"></i>
                                        <i class="bi bi-star-fill"></i>
                                        <i class="bi bi-star-fill"></i>
                                ...
                                <div class="d-flex justify-content-between">
                                    <small>Difficulty : Easy</small>
                                    <a href="https://github.com/Chandrasrinivas12/Mern-task2" target="_blank" class="btn btn-outline-success active">View the Code</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <form action="">
                            ...
                            <div class="mb-4 input-group">
                                ...
                                <input type="text" class="form-control" id="name" placeholder="e.g. Chandra Srinivas P" required/>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="project-1" class="accordion-collapse collpase show" aria-labelledby="heading-1" data-bs-parent="#projects_list">
                                    <div class="accordion-body">
                                        ...
                                        <a href="https://github.com/Chandrasrinivas12/MERN_tasks" class="btn btn-outline-danger me-2" >App</a>
                                        <a href="https://github.com/Chandrasrinivas12/MERN_tasks" target="_blank" class="btn btn-outline-danger" >Code</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="project-2" class="accordion-collapse collpase" aria-labelledby="heading-2" data-bs-parent="#projects_list">
                                    <div class="accordion-body">
                                        ...
                                        <a href="https://github.com/Chandrasrinivas12/Mern-task2" target="_blank" class="btn btn-outline-danger" >Code</a>
                                    </div>
                                </div>
                            </div>
                        </div>
